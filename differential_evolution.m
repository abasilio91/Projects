...
function [bestmem,bestval,nfeval] = de(fname,VTR,D,XVmin,XVmax,y,NP,itermax,F,CR,strategy,refresh);
...
%----Output section----------------------------------------------------------
  ...
  fprintf(1,' ===============================================================================================================\n');
  if (refresh > 0)
       fprintf(1,'  Iteration: %d,          Best Value: %f,  Average: %f,  Worst: %f,  Stop: %f\n',iter,bestval,average,worst,abs(bestval-worst));
       for n=1:D
         fprintf(1,'     x(%d) = %1.6e',n,bestmem(n));
       end
     fprintf(1,'\n');
  end
...
%save evolutive_process.txt ninteration -ASCII
